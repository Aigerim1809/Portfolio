    ...
    >
        ...
        <div>
            <ul className="mil-puplication-details mil-up mil-mb-90">
                <li>
                    <span className="mil-upper mil-accent">Звоните: </span>&nbsp;&nbsp;
                    <span className="mil-upper mil-dark">+7 747 267 80 71</span>
                </li>
                <li>
                    <span className="mil-upper mil-accent">Напишите мне: </span>&nbsp;&nbsp;
                    <span className="mil-upper mil-dark">aigerim.madiomarova@narxoz.kz</span>
                </li>
            </ul>
        </div>
